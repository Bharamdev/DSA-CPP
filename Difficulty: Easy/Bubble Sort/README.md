<h2><a href="https://www.geeksforgeeks.org/problems/bubble-sort/0">Bubble Sort</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an Integer <strong>n</strong> and a list <strong>arr</strong>. Sort the array using bubble sort algorithm.</span><br><span style="font-size: 18px;"><strong><br>Examples :<br></strong></span></p>
